...
(6, 'flight_discount', '20% off domestic flights', 'April', NULL, 'Airports across Canada', 'Air Canada', 'logo_air_canada', 'https://www.aircanada.com', 5),
(7, 'receive_salad', 'Receive a free salad when you order any main dish', 'From April 1st to May 31st', NULL, 'Participating Freshii locations across Canada', 'Freshii Canada', 'logo_freshii', 'https://www.freshii.com', 6),
(8, 'donate_blood', 'Donate blood today!', 'Mondays to Saturdays', '10am to 4pm', 'Locations across Ontario', 'Canadian Blood Services', 'logo_blood_services', 'https://blood.ca', 7),
(9, 'student_workshop', 'Student Organ Donation Workshop', 'April 22nd', '10am to 12pm', 'Schools across Toronto', 'The Toronto District School Board', 'logo_toronto_school_board', 'http://www.tdsb.on.ca', 8);
